...
//	public final static String PUBLIC_OUTPUT = Paths.get(System.getProperty("user.dir"),"output").toString();
	public final static String PUBLIC_OUTPUT = "D:\\scrallOutput";
	...
	// output of crawlers
	public final static String OUTPUT_SUBJECTS_URLS_FILE_ABSOLUTE_PATH = Paths.get(PUBLIC_OUTPUT,
			"questionsUrls.txt").toString();
