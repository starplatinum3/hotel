...
public class PageUtil {
    ...
    /**
     * 传入的参数 需要从0 开始,第一页是 pageIndex=0
     * @param pageIndex
     * @param pageSize
     * @return
     */
...
//    public static  Page listToPage(List list, int pageIndex, int pageSize) {
...
//        return redRecordUserEquipPage;
    ...
    public static <T> Page listToPageOfMap(List<Map<String, Object>> list, int pageIndex, int pageSize) {
