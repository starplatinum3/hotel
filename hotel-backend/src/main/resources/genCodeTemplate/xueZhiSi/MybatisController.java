...
import top.starp.util.#returnType#;
...
@RequestBody #类名# example,
@RequestParam(required = false, defaultValue = "1") int pageNumber,
@RequestParam(required = false, defaultValue = "10") int pageSize
        ) {
        PageHelper.startPage(pageNumber,pageSize);

        #类名#Example #实体名#Example = new #类名#Example();
        #类名#Example.Criteria criteria = #实体名#Example.createCriteria();
        #andEqualToList#


//        List<#类名#> #实体名#s = #实体名#Mapper.selectByExample(#实体名#Example);
        Page<#类名#> page = (Page<#类名#>)#实体名#Mapper.selectByExample(#实体名#Example);
        //查询

//        return RestResponse.ok(#实体名#s);
