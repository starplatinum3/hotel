...
let routes = [
    ...
    //                 /* webpackChunkName: "order" */ '../views/hall/order/ReservedOrder.vue'
    //         ),
    // },
];
...
// routes.app 
// for 
const appenAll=(lst,toAppend)=>{

    for(let o of toAppend){
        lst.push(o)
    }
}
...
for(let o of asyncRoutes){
    o.path="/"+o.path
}

appenAll(routes,asyncRoutes)
...
// import {doDebug} from '@/utils/common'

import {isDoDebug} from '@/utils/common'

// router.beforeEach(async (to, from, next) => {
//     loading.close();
//     console.log("isDoDebug")
//     console.log(isDoDebug)
